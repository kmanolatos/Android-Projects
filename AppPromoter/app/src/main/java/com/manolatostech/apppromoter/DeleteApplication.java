...
public class DeleteApplication extends AsyncTask<String, Void, String> {
    ...
    public DeleteApplication(HomeActivity homeActivity, TextView toastMessage, int h, ProgressBar progressBar, ArrayList<ApplicationModel> myApps, int index, RelativeLayout relativeLayout, EditText[] editTextArray, ImageView[] imageViewLink, ImageView[] imageViewEdit, ImageView[] imageViewDelete, DrawerLayout drawer) {
    ...
    protected String doInBackground(String... arg0) {
        try {
            ...
            String link = "http://manolatostechapppromoter.atwebpages.com/deleteApplication.php";
    ...
    protected void onPostExecute(String result) {
        ...
        if (!result.equals("ok")) {
            ...
            toastMessage.setText("App deleted successfully!");
